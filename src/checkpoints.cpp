...
{    
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (    0,     uint256("0x23d9665972a65317817c1ec19c90d3c54b3c030d3ffdf39202976215b8900dfc"))
        ;
    static const CCheckpointData data = {
        &mapCheckpoints,
        1395574710, // * UNIX timestamp of last checkpoint block
        132768,     // * total number of transactions between genesis and last checkpoint
